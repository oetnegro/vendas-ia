...
- [x] **Google Cloud Run** — hospeda ADK + MCP server
- [x] **Cloud Scheduler** — substitui n8n no agendamento do cron
- [x] **Cloud Logging** — traces do agente (alimentam os evals)
